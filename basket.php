	...
	if (!isset($_SESSION["cart_array"]) || count($_SESSION["cart_array"]) < 1) {
		...
		foreach ($_SESSION["cart_array"] as $each_item) { 
			...
			$chkbtn = '<div class="checkout">
							...
							<a href="Euro" onclick="show_overlay(); return false">Checkout</a>
...
<div class="content remove_pad" onclick="remove_class()">
	...
	<div class="inner_content on_parallax">
		...
		<h2><span class="cart">winkelwagen</span></h2>
...
<div class="overlay" id="overlay" onclick="hide_overlay()"></div>
	...
	<div class="info_holder">
		...
		<h2><span class="tag">Bestelling afronden</span></h2>
		...
		<form method="post" action="" onSubmit="validate_input(); return false">
			...
			<div class="form_group">
				...
				<div class="form_group">
					...
					<label>Adress</label>
					<input type="text" id="addr"  name="addr" placeholder="Enter your adress" required>
