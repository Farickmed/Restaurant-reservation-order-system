			...
			<div class="detail_holder">
				...
				<div class="detail_desc">
					...
					<form class="" method="post" action="detail.php">
						...
						<p><span class="bold_desc">Categorie:</span> <?php echo $cat; ?></p>
						<p><span class="bold_desc price">Prijs in euro:</span> <span id="price"><?php echo $price; ?></span></p>
						<div class="form_group">
							
							<p><span class="bold_desc">Hoeveelheid:</span></p>
						...
						<p><span class="bold_desc">Totaal:</span> <span id="total_price"><?php echo $price; ?></span></p>
